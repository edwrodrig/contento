...
public $entity = '\edwrodrig\contento\data\Entity';
public $data = [];
public $id = 'collection';

function __construct($id, $entity = '\edwrodrig\contento\data\Entity') {
  $this->id = $id;
  $this->entity = $entity;
}
...
function getIterator() {
  return Utils::entity_iterator($this->data, $this->entity);
}
