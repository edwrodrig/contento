...
use edwrodrig\contento\data\EntityDuration;

class EntityDurationTest extends \PHPUnit\Framework\TestCase { 

function collection($data) {
  $collection = new \edwrodrig\contento\data\Collection('durations', '\edwrodrig\contento\data\EntityDuration');
  $collection->set($data);
  return $collection;
}
